...
#import "ReaderVFRViewController.h"
...
@interface ReaderVFRViewController () <UIScrollViewDelegate, UIGestureRecognizerDelegate, MFMailComposeViewControllerDelegate, UIDocumentInteractionControllerDelegate,
ReaderMainToolbarDelegate, ReaderMainPagebarDelegate, ReaderContentViewDelegate, ThumbsViewControllerDelegate>
@end

@implementation ReaderVFRViewController
{
...
#pragma mark - ReaderVFRViewController methods
...
- (void)addContentView:(UIScrollView *)scrollView page:(NSInteger)page
{
    ...
    NSString *documentDirectory =[NSString stringWithFormat:@"file://%@/%@", [paths objectAtIndex:0], document.fileName];
    NSURL *fileURL =  [NSURL URLWithString:documentDirectory];
...
- (void)closeDocument
{
    ...
    if ([delegate respondsToSelector:@selector(dismissReaderVFRViewController:)] == YES)
    {
        [delegate dismissReaderVFRViewController:self]; // Dismiss the ReaderVFRViewController
    }
    else // We have a "Delegate must respond to -dismissReaderVFRViewController:" error
    {
        NSAssert(NO, @"Delegate must respond to -dismissReaderVFRViewController:");
    }
}
...
- (void)viewDidLoad
{
    ...
    pagebarRect.origin.y = (self.view.bounds.size.height - pagebarRect.size.height - 44.0f);
...
- (void)tappedInToolbar:(ReaderMainToolbar *)toolbar doneButton:(UIButton *)button
{
    ...
    [self closeDocument]; // Close ReaderVFRViewController
