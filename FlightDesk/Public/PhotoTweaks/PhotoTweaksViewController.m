...
- (void)setupSubviews
{
    ...
    cancelBtn.frame = CGRectMake(8, CGRectGetHeight(self.view.frame) - 35, 70, 30);
    ...
    cropBtn.frame = CGRectMake(CGRectGetWidth(self.view.frame) - 70, CGRectGetHeight(self.view.frame) - 35, 70, 30);
    ...
    cropBtn.layer.borderColor = saveButtonTitleColor.CGColor;
    cropBtn.layer.borderWidth = 1.0f;
    cropBtn.layer.cornerRadius = 5.0f;
