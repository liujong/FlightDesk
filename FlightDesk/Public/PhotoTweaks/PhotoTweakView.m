             ...
             maxRotationAngle:(CGFloat)maxRotationAngle
{
    if (self = [super init]) {
        ...
        _slider.center = CGPointMake(CGRectGetWidth(self.bounds) / 2, CGRectGetHeight(self.bounds) - 20);
        ...
        _resetBtn.frame = CGRectMake(0, 0, 70, 30);
        _resetBtn.center = CGPointMake(120, CGRectGetHeight(self.bounds)-20);
        ...
        _resetBtn.layer.borderColor = [UIColor resetButtonColor].CGColor;
        _resetBtn.layer.borderWidth = 1.0f;
        _resetBtn.layer.cornerRadius = 5.0f;
        [self addSubview:_resetBtn];
        
        UIImageView *leftRotateImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 30, 30)];
        leftRotateImageView.center = CGPointMake(CGRectGetWidth(self.bounds) / 2 - 155, CGRectGetHeight(self.bounds) - 20);
        [leftRotateImageView setImage:[UIImage imageNamed:@"left_rotate"]];
        [self addSubview:leftRotateImageView];
        
        UIImageView *rightRotateImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 30, 30)];
        rightRotateImageView.center = CGPointMake(CGRectGetWidth(self.bounds) / 2 + 155, CGRectGetHeight(self.bounds) - 20);
        [rightRotateImageView setImage:[UIImage imageNamed:@"right_rotate"]];
        [self addSubview:rightRotateImageView];
