...
- (void)viewDidLoad
{
    ...
    self.resultLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 10, TEXTAREA_WIDTH, TEXTAREA_HEIGHT)];
...
//    [self addButtonWithTitle:@"mr"      tag:kButtonMR           row:0 column:3 width:1 height:1];
    ...
    [self addButtonWithTitle:@"AC"      tag:kButtonAC           row:0 column:0 width:1 height:1];
    [self addButtonWithTitle:@"\u00B1"  tag:kButtonChangeSign   row:0 column:1 width:1 height:1];
    [self addButtonWithTitle:@"\u00F7"  tag:kButtonDivide       row:0 column:2 width:1 height:1];
    [self addButtonWithTitle:@"\u00D7"  tag:kButtonMultiply     row:0 column:3 width:1 height:1];
    
    [self addButtonWithTitle:@"7"       tag:kButtonSeven        row:1 column:0 width:1 height:1];
    [self addButtonWithTitle:@"8"       tag:kButtonEight        row:1 column:1 width:1 height:1];
    [self addButtonWithTitle:@"9"       tag:kButtonNine         row:1 column:2 width:1 height:1];
    [self addButtonWithTitle:@"\u2212"  tag:kButtonSubtract     row:1 column:3 width:1 height:1];
    
    [self addButtonWithTitle:@"4"       tag:kButtonFour         row:2 column:0 width:1 height:1];
    [self addButtonWithTitle:@"5"       tag:kButtonFive         row:2 column:1 width:1 height:1];
    [self addButtonWithTitle:@"6"       tag:kButtonSix          row:2 column:2 width:1 height:1];
    [self addButtonWithTitle:@"+"       tag:kButtonAdd          row:2 column:3 width:1 height:1];
    
    [self addButtonWithTitle:@"1"       tag:kButtonOne          row:3 column:0 width:1 height:1];
    [self addButtonWithTitle:@"2"       tag:kButtonTwo          row:3 column:1 width:1 height:1];
    [self addButtonWithTitle:@"3"       tag:kButtonThree        row:3 column:2 width:1 height:1];
    [self addButtonWithTitle:@"="       tag:kButtonEqual        row:3 column:3 width:1 height:2];
    
    [self addButtonWithTitle:@"0"       tag:kButtonZero         row:4 column:0 width:2 height:1];
    [self addButtonWithTitle:@"."       tag:kButtonDot          row:4 column:2 width:1 height:1];
}
...
- (void)doOperation:(int)theOperation
{
  ...
  // leftOperator = [NSNumber numberWithDouble:[resultText doubleValue]];
   ...
   // leftOperator = nil;
    ...
    leftOperator = [NSNumber numberWithDouble:result];
}
...
- (void)buttonPressed:(id)sender
{
    ...
    if (deleteInput && row != kButtonChangeSign) {
