...
- (void)calendarYearView:(MGCYearCalendarView*)controller didSelectDateAtMonthDate:(NSDate*)date{
    if ([self.delegate respondsToSelector:@selector(yearViewController:didSelectDateAtMonthDate:)]) {
        [self.delegate yearViewController:self didSelectDateAtMonthDate:date];
    }
}
