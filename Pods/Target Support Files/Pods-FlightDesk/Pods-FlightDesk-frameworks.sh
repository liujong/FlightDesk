...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/DFContinuousForceTouchGestureRecognizer/DFContinuousForceTouchGestureRecognizer.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/DFImageManager/DFImageManager.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FLAnimatedImage/FLAnimatedImage.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/GTMSessionFetcher/GTMSessionFetcher.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/GoogleUtilities/GoogleUtilities.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ILPDFKit/ILPDFKit.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RGBColorSlider/RGBColorSlider.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/UIView+DragDrop/UIView_DragDrop.framework"
